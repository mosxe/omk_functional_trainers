        ...
        <div className={styles.starting__container}>
          <div className={styles.starting__card}>
            <div className={styles.starting__card_wrapper}>
              <img
                ...
                alt='Картинка'
              />
              <div className={styles.starting__card_title}>Заполни анкету</div>
              <div className={styles.starting__card_text}>
                Нажми на ссылку, заполни и отправь анкету куратору
              </div>
            </div>
            <button className={styles.starting__card_btn} type='button'>
              Заполнить анкету
            </button>
          </div>
          <div className={styles.starting__card}>
          ...
          <div className={styles.starting__card}>
            <div className={styles.starting__card_wrapper}>
              ...
              <div className={styles.starting__card_text}>
                Диагностика базовых навыков передачи информации позволит понять,
                какие компетенции преподавания тебе необходимо развивать
              </div>
            </div>
          </div>
          <div className={styles.starting__card}>
